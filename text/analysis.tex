...
Jako další aplikaci jsem si vybral Jíme zdravě. Aplikace měla výborné hodnocení a poměrně vysoký počet stažení na to o jakou aplikaci se jedná.
...
stránky, které jsem zahrnul v porovnání a přidal jsem skóre, které je v souladu s parametry mojí aplikace. V tabulce jsou pouze
webové stránky.
...
\begin{table}[H]\centering
    ...
    \begin{tabular}{l|c|c|c|c}
        ...
        \footnote{Hodnocení recipeo.cz je na základě návrhu, ne podle výsledné verze}  \tabularnewline \hline
