...
\section{Vuex}
Knihovna Vuex~\cite{Vuex} se využívá pro uložení stavu aplikace. Je potřeba využít u dat, která jsou využívána na více místech a jejich
...
\section{Firebase}
Firebase~\cite{Firebase} jsem použil na backendu. To mi umožnilo mít vše na jednom místě. Uložiště, databázi, autorizaci uživatelů, hosting atd.
...
\begin{itemize}
    ...
    Dostupné pro všechny uživatele nehledě na typ prohlížeče
    \item Responzivní
    ...
    Poskytují vždy aktuální data díky procesu update technologie \emph{service workers}
    \item Zabezpečená
