...
\section{Firebase}
Firebase~\cite{Firebase} jsem použil na backendu. To mi umožnilo mít vše na jednom místě. Uložiště, databázi, autorizaci uživatelů, hosting atd. % TODO What is this? PaaS
...
denně nebo měsíčně, podle toho o jaký podsystém se jedná.
