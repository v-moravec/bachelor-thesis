...
\begin{figure}[H]
    \centering
    \subfloat[Schovaný odkaz na přidání receptu]{\includegraphics[width=0.4\textwidth]{images/recipeo-hover}\label{picture:recipeo:hover}}
    \hfill
    \subfloat[Přidaný viditelný odkaz u seznamu receptů]{\includegraphics[width=0.5\textwidth]{images/recipeo-add-button}\label{picture:recipeo:add-button}}
...
Vzhledem k nízkému počtu chyb v uživatelském rozhraní si dovolím říct, že frontend aplikace testem použitelnosti prošel. Až na některé
