...
\begin{figure}[h]
    \centering
    \subfloat[Úvodní obrazovka]{\includegraphics[width=0.3\textwidth]{pdf/adobexd/zobrazeni-receptu-priprava-mobil}\label{picture:recipeo:navrh:zobrazeni-receptu-priprava-mobil}}
    \hfill
    \subfloat[Zobrazení seznamu receptů]{\includegraphics[width=0.3\textwidth]{pdf/adobexd/zobrazeni-receptu-suroviny-mobil}\label{picture:recipeo:navrh:zobrazeni-receptu-suroviny-mobil}}
    \hfill
    \subfloat[Zobrazení receptu]{\includegraphics[width=0.3\textwidth]{pdf/adobexd/rychly-navrh-mobil}\label{picture:recipeo:navrh:rychly-navrh-mobil}}
    \caption{Návrhy v mobilním zobrazení}
\end{figure}
\vspace*{\fill}
\clearpage
