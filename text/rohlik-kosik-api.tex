...
\section{Možnosti}
Vedoucí práce již dříve používal aplikaci Zdravý stůl. Tam bylo možné si jídlo objednat přes rohlik.cz (vložit do košíku).
...
zjistili, že API pro partnery narozdíl od Rohlíku ještě dostupné není, ale už na něm pracují. Plánované období vydání je
...
poté objevili funkci "Nákupní lístek", kterou bychom mohli využít. Odeslali bychom seznam surovin a uživatel by si je poté
